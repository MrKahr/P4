...
public class StringCastInterpreter extends InterpreterVisitor {
    ...
    public void visit(AST node) {
        ...
        SymbolTableEntry toConvert = InterpreterVisitor.getReturnSymbol();
        ...
        try {
            ...
            InterpreterVisitor.setReturnSymbol(toReturn);
