...
- [ ] If the last line of a DBL program is a comment, the interpreter will fail with a parse error. A quick work-around is ensure that an empty line is always the last line in the program. 
